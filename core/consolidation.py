...
# ═══════════════════════════════════════════════════════════════════════════════
# Profile Extractor — direct conversation → profile_items extraction
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# Profile Extraction Runtime Mixin
# ═══════════════════════════════════════════════════════════════════════════════
...
class ProfileExtractionRuntimeMixin:
    ...
    async def _run_profile_extraction_cycle(
        ...
        try:
            ...
            logger.warning("[tmemory] profile extraction error: %s", e)
            return 0
        ...
        for canonical_id in pending_users:
            try:
                ...
                try:
                    ...
                    logger.warning(
                        "[tmemory] profile extraction LLM failed for user %s: %s",
                        canonical_id, e,
                    )
                    self._mark_rows_distilled([int(r["id"]) for r in rows])
                    continue
                ...
                logger.warning(
                    "[tmemory] profile extraction failed for user %s: %s",
                    canonical_id, e,
                )
